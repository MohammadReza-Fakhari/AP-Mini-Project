...
batman_music = pygame.mixer.Sound("batman.mp3")
...
class WinPage:
    def __init__(self, winner):
        ...
        self.buttons = [
            Button("Main Menu", (300, 350), (200, 60), WHITE, GREEN, BLUE, 1),
            Button("Quit", (300, 430), (200, 60), WHITE, RED, BLUE, 4)
        ]
        self.run()
    ...
    def run(self):
        ...
        while running:
            ...
            for button in self.buttons:
                action = button.update(screen, mouse_pos, 0, click)
                if action == 1:  
                    running = False
                    Game().run()
                elif action == 4:  
